                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover cms-table">
                        ...
                        <?php if(is_array($admins)): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>    <a class="www" href="javascript:void(0)" attr-id="<?php echo ($vo["admin_id"]); ?>" id="cms-delete"  attr-a="admin" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>
