      ...
      <div class="col-sm-9 col-md-9">
        <div class="banner">
          <div class="banner-left">
            <div class="banner-info"><span>阅读数</span><i class="news_count node-$resultPic[0]['news_id']}" news-id="$resultPic[0]['news_id']}" id="node-$resultPic[0]['news_id']}"><?php echo ($count); ?></i></div>
