        ...
        <form>
          <div class="col-md-3">
            <div class="input-group">
              ...
              <select class="form-control" name="catid" id="testSelect">
                <option value='' >全部分类</option>
                <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?><option value="<?php echo ($sitenav["menu_id"]); ?>" <?php if($sitenav['menu_id'] == $sitenavmenuId): ?>selected="selected"<?php endif; ?> ><?php echo ($sitenav["name"]); ?></option><?php endforeach; endif; ?>
              </select>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="input-group">
              <input class="form-control" name="title" type="text" value="<?php echo ($title); ?>" placeholder="文章标题"  id="testTitle"/>
                <span class="input-group-btn">
                  <button id="sub_data"  class="btn btn-primary" type="button" onclick="searchTo()"><i class="glyphicon glyphicon-search"></i></button>
        ...
        <div class="col-lg-6">
          ...
          <div class="table-responsive">
            <form id="cms-listorder">
              <table class="table table-bordered table-hover cms-table">
                ...
                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    <td><input type="checkbox" name="pushcheck" value="<?php echo ($new["news_id"]); ?>" id="pushcheck"></td>
            ...
            <div class="input-group">
              ...
              <button id="cms-push" type="button" class="btn btn-primary" onclick="searchTo()">推送</button>
            </div>
...
<script>
  var SCOPE = {
      ...
      'search_url' :'/admin.php?c=content&a=search'
  }
</script>
